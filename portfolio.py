...
print(max_sharpe_port) # print portfolio percentage with the highest sharpe value
print(min_vol_port) # print portfolio percentage with the lowest volatility
